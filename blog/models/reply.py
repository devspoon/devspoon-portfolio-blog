...
from .boards import ProjectPost, OnlineStudyPost, BlogPost, InterestingOpenSourcePost, BooksPost
...
class InterestingOpenSourcePostReply(Reply):
    post = models.ForeignKey(InterestingOpenSourcePost, on_delete=models.CASCADE)
    
    class Meta:
        db_table = 'interesting_open_source_post_reply'
        verbose_name = _('interesting open source post reply')
        verbose_name_plural = _('interesting open source post reply')
