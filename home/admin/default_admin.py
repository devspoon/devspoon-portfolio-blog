...
from custom_middlewares.models import ConnectionMethodStats, ConnectionHardwareStats
from custom_middlewares.admin.home_statistics_admin import ConnectionMethodStatsAdmin, ConnectionHardwareStatsAdmin
